...
const AddCoffee = () => {
    ...
    return (
        <div className="bg-[#F4F3F0] p-24 mx-auto">
            <h2 className="text-3xl font-extrabold mb-12 text-center">Add a Coffee</h2>
            <form onSubmit={handleAddCoffee}>
                ...
                {/* <button className="btn btn-block mt-12 bg-[#D2B48C] text-[#331A15]">Add Coffee</button> */}
                <input className="btn btn-block mt-12 bg-[#D2B48C] text-[#331A15]" type="submit" value="Add Coffee" />
            </form>
        </div>
    );
};
